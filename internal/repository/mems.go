...
func (r *Repository) UpdateMem(ctx context.Context, filter map[string]string, update map[string]string) error {
...
func (r *Repository) GetMems(ctx context.Context, filter map[string]string) ([]entity.Mem, error) {
...
func (r *Repository) DeleteMem(ctx context.Context, filter map[string]string) error {
